AppManager::paypal = ->
        ...
        @app.get '/paypal/invoices/novo', (req, res) ->    
                paypal_rest_sdk.invoice.create create_invoice(req), (err, payment) ->
                        if err then res.json err
                        res.json payment_id:payment.id

        @app.get '/paypal/invoices/:id', (req, res) ->
        ...
        @app.get '/paypal/invoices/:id/cancel', (req, res) ->
                options = 
